...
type
  ...
  Tfrm_cliente = class(TForm)
    ...
    procedure btn_imprimirTodosClick(Sender: TObject);
...
procedure Tfrm_cliente.btn_BuscarClick(Sender: TObject);
var
  I: Integer;
  achou : Boolean;
begin
  achou := false;
  for I := 0 to 10 do
    if aClientes[I].codigo = StrToInt(edt_codigo.Text) then
    begin
      edt_codigo.Text := IntToStr(aClientes[I].codigo);
      edt_idade.Text := IntToStr(aClientes[I].idade);
      edt_nome.Text := aClientes[I].nome;
      edt_sobrenome.Text := aClientes[I].sobrenome;
      edt_cidade.Text := aClientes[I].cidade;
      edt_salario.Text := FloatToStr(aClientes[I].salario);
      cbAtivo.IsChecked := aClientes[I].ativo;
      if aClientes[I].sexo = 'Masculino' then
        cbSexo.ItemIndex := 0
      else
        cbSexo.ItemIndex := 1;
      achou := true;
...
procedure Tfrm_cliente.btn_imprimirTodosClick(Sender: TObject);
var
  I: Integer;
begin
  ...
  begin
    ...
    begin
      Memo1.Lines.Add('Cliente cod: ' + IntToStr(aClientes[I].codigo));
      Memo1.Lines.Add('Nome completo: ' + aClientes[I].nome + ' ' + aClientes[I].sobrenome);
      memo1.Lines.Add('Idade: '+IntToStr(aClientes[I].idade));
      memo1.Lines.Add('Cidade: '+aClientes[I].cidade);
      memo1.Lines.Add('Salario: ' + FloatToStr(aClientes[I].salario));
      memo1.Lines.Add('Ativo: '+aClientes[I].ativo.ToString());
      memo1.Lines.Add('=====================');
    end;
  end;
